...
class HomeViewController: UIViewController, SkinMatrixToggleDelegate {
    ...
    func registerCells() {
        ...
        homeCollectionView.register(UINib(nibName: "AffirmationCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "affirmation_cell")
...
extension HomeViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case 3:
            ...
            cell.configure(title: "Track your skin progress",
                           points: insight.points,
                           weeklyPoints: insight.weekly,
                           description: "Based on hydration, clarity, texture & tone",
        ...
        default:
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "affirmation_cell", for: indexPath) as! AffirmationCollectionViewCell
            if let a = dataModel.nextAffirmation() {
                cell.configure(title: "Daily Affirmation", message: a.text)
            }
            return cell
        }
    }
...
extension HomeViewController {
    ...
    func generateLayout() -> UICollectionViewLayout {
        UICollectionViewCompositionalLayout { section, _ in
            switch section {
            case 0: return self.simpleSection(50)
            case 1: return self.simpleSection(120)
            case 2:
                ...
                return section
            case 3:
                let s = self.simpleSection(350)
                s.contentInsets = NSDirectionalEdgeInsets(top: 0, leading: 0, bottom: 0, trailing: 0)
                s.boundarySupplementaryItems = [self.generateHeader()]
                return s
            case 4:
                return self.generateSkinMatrixSection()
            case 5:
                let s = self.simpleSection(160)
                s.boundarySupplementaryItems = [self.generateHeader()]
                return s
            default:
                return self.simpleSection(180)
            }
        }
    }
    ...
    func generateSkinMatrixSection() -> NSCollectionLayoutSection {
        ...
        let toggle = NSCollectionLayoutBoundarySupplementaryItem(
            layoutSize: NSCollectionLayoutSize(
                widthDimension: .fractionalWidth(1.0),
                heightDimension: .absolute(44)
            ),
            elementKind: "toggle-kind",
            alignment: .bottom
        )
