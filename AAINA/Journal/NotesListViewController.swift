...
class NotesListViewController: UIViewController {
    ...
    var onEntryUpdated: ((JournalEntry) -> Void)?
    ...
    private func setupSearch() {
        ...
        searchController.searchBar.placeholder                = "Search notes, tags…"
...
extension NotesListViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView,
        ...
        cell.configure(entry: displayed[indexPath.row], showFullDate: true)
        return cell
    }
